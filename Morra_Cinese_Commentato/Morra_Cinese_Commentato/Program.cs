...
namespace Morra_Cinese_Commentato
{
    class Program
    {
        ...
        public static string Scelta_Giocatore_2;
        ...
        static void Nomi_Giocatori() //Vengono richiesti i nomi di entrambi i giocatori
        {
            ...
            nome_giocatore_2 = Console.ReadLine();
        }
        ...
        static void Giocatore_2() //Viene richiesta la mossa del giocatore 2
        {
            Console.Write("\nOra e' il turno del giocatore ");
            Console.ForegroundColor = ConsoleColor.Magenta;
        ...
        static void Convertitore_Giocatore_2() //Converte la scelta del giocatore 2 da i caratteri inseriti a Sasso, Carta o Forbice
        {
        ...
        {
            Nomi_Giocatori(); //Vengono richiesti i nomi di entrambi i giocatori
            ...
            do
            {
                ...
                Giocatore_2(); //Viene richiesta la mossa del giocatore 2
                Convertitore_Giocatore_2(); //Converte la scelta del giocatore 2 da i caratteri inseriti a Sasso, Carta o Forbice
